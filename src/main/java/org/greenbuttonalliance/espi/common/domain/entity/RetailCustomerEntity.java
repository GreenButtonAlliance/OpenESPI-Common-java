 ...
 * 
 * Represents a retail energy customer with authentication capabilities.
 * Implements Spring Security UserDetails and Principal interfaces for
 * authentication and authorization within the energy data system.
 */
@Entity
...
public class RetailCustomerEntity extends IdentifiedObjectEntity implements UserDetails, Principal {
    ...
    /**
     * Adds a usage point to this customer.
    ...
    public void addUsagePoint(UsagePointEntity usagePoint) {
        if (usagePoint != null) {
            ...
            usagePoint.setRetailCustomer(this);
        }
    }

    /**
     * Removes a usage point from this customer.
    ...
    /**
     * Adds an authorization to this customer.
     * Sets up the bidirectional relationship.
     * 
    ...
    public void addAuthorization(AuthorizationEntity authorization) {
        if (authorization != null) {
            ...
            authorization.setRetailCustomer(this);
        }
    }

    /**
     * Removes an authorization from this customer.
     * Clears the bidirectional relationship.
     * 
     * @param authorization the authorization to remove
     */
    public void removeAuthorization(AuthorizationEntity authorization) {
        if (authorization != null) {
            this.authorizations.remove(authorization);
            authorization.setRetailCustomer(null);
        }
    }
    ...
    public void unlink() {
        ...
        for (AuthorizationEntity authorization : new ArrayList<>(authorizations)) {
    ...
    /**
     * Pre-persist callback to set account creation time.
     */
    @PrePersist
