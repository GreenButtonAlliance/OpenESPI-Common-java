...
public class ReadingTypeEntity extends IdentifiedObjectEntity {
    ...
    /**
     * Adds a meter reading that uses this reading type.
    ...
    public void addMeterReading(MeterReadingEntity meterReading) {
        if (meterReading != null) {
            ...
            meterReading.setReadingType(this);
        }
    }

    /**
     * Removes a meter reading from this reading type.
    ...
    public void removeMeterReading(MeterReadingEntity meterReading) {
        if (meterReading != null) {
            this.meterReadings.remove(meterReading);
    ...
    public void unlink() {
        ...
        for (MeterReadingEntity meterReading : new ArrayList<>(meterReadings)) {
