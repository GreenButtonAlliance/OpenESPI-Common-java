...
/**
 * Pure JPA/Hibernate entity for ElectricPowerUsageSummary without JAXB concerns.
 * 
 * Represents a summary of electric power usage for a billing period.
 * Contains billing information, consumption measurements, peak demand data,
 * and additional cost details for electric power usage.
 */
@Entity
...
public class ElectricPowerUsageSummaryEntity extends IdentifiedObjectEntity {
     ...
     */
    @OneToMany(mappedBy = "electricPowerUsageSummary", cascade = CascadeType.ALL, orphanRemoval = true)
     ...
     */
    public ElectricPowerUsageSummaryEntity(DateTimeInterval billingPeriod, Long billLastPeriod, Long billToDate) {
    ...
    public void addCostAdditionalDetailLastPeriod(LineItemEntity lineItem) {
        if (lineItem != null) {
            ...
            lineItem.setElectricPowerUsageSummary(this);
        }
    }
    ...
    public void removeCostAdditionalDetailLastPeriod(LineItemEntity lineItem) {
        if (lineItem != null) {
            ...
            lineItem.setElectricPowerUsageSummary(null);
        }
    }

    /**
     * Sets the usage point for this summary.
    ...
    public void setUsagePoint(UsagePointEntity usagePoint) {
        ...
        if (this.usagePoint != null && this.usagePoint != usagePoint) {
            this.usagePoint.removeElectricPowerUsageSummary(this);
        }
        
        this.usagePoint = usagePoint;
        
        // Add to new usage point if not null
        if (usagePoint != null && !usagePoint.getElectricPowerUsageSummaries().contains(this)) {
            usagePoint.addElectricPowerUsageSummary(this);
        }
    }

    /**
     * Generates the self href for this electric power usage summary.
     * 
     * @return self href string
     */
    public String getSelfHref() {
        if (usagePoint != null) {
            return usagePoint.getSelfHref() + "/ElectricPowerUsageSummary/" + getHashedId();
        }
        return "/espi/1_1/resource/ElectricPowerUsageSummary/" + getHashedId();
    }

    /**
     * Generates the up href for this electric power usage summary.
     * 
     * @return up href string pointing to the usage point
     */
    public String getUpHref() {
        if (usagePoint != null) {
            return usagePoint.getSelfHref() + "/ElectricPowerUsageSummary";
        }
        return "/espi/1_1/resource/ElectricPowerUsageSummary";
    }

    /**
     * Overrides the default self href generation to use electric power usage summary specific logic.
     * 
     * @return self href for this electric power usage summary
     */
    @Override
    ...
    /**
     * Overrides the default up href generation to use electric power usage summary specific logic.
     * 
     * @return up href for this electric power usage summary
     */
    @Override
    ...
    /**
     * Merges data from another ElectricPowerUsageSummaryEntity.
     * Updates all summary data and embedded measurements.
     * 
     * @param other the other electric power usage summary entity to merge from
     */
    public void merge(ElectricPowerUsageSummaryEntity other) {
        if (other != null) {
            super.merge(other);
    ...
    public void setUpResource(IdentifiedObjectEntity resource) {
        if (resource instanceof UsagePointEntity usagePointEntity) {
            usagePointEntity.addElectricPowerUsageSummary(this);
        }
    }
