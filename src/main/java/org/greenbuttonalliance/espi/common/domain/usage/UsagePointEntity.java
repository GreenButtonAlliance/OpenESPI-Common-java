...
public class UsagePointEntity extends IdentifiedObjectEntity {
    ...
    /**
     * Adds a meter reading to this usage point.
     * 
     * @param meterReading the meter reading to add
     */
    public void addMeterReading(MeterReadingEntity meterReading) {
    ...
    /**
     * Removes a meter reading from this usage point.
     * 
     * @param meterReading the meter reading to remove
     */
    public void removeMeterReading(MeterReadingEntity meterReading) {
        if (meterReading != null) {
     ...
     * 
     * @param summary the usage summary to add
     */
    public void addUsageSummary(UsageSummaryEntity summary) {
        if (summary != null) {
    ...
    /**
     * Removes a usage summary from this usage point.
     * 
     * @param summary the usage summary to remove
     */
    public void removeUsageSummary(UsageSummaryEntity summary) {
        if (summary != null) {
            summary.setUsagePoint(null);
            usageSummaries.remove(summary);
        }
    }
    ...
    /**
     * Adds a subscription to this usage point.
     * 
    ...
    public void addSubscription(SubscriptionEntity subscription) {
        if (subscription != null) {
            ...
            subscription.getUsagePoints().add(this);
        }
    }

    /**
     * Removes a subscription from this usage point.
     * 
    ...
    public void removeSubscription(SubscriptionEntity subscription) {
        if (subscription != null) {
            ...
            subscription.getUsagePoints().remove(this);
        }
    }
    ...
    /**
     * Checks equality with another UsagePointEntity based on ID.
     * 
     * @param other the other usage point to compare with
     * @return true if the IDs are equal
     */
    public boolean equals(UsagePointEntity other) {
