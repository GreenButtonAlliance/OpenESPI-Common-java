...
public class BaseStepUtils {
	...
	public static void selectRadioByLabel(String labelText) {
		driver.findElement(
				By.xpath("//label[contains(.,'" + labelText + "')]/input"))
				.click();
	}
	...
	public static void assertContains(String text) {
		assertTrue("Page source did not contain '" + text + "'", driver
	...
	public static void registerUser(String context, String username,
