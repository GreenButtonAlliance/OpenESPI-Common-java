...
CREATE TABLE `line_item` (
  ...
  KEY `fk_line_item_1` (`usage_summary_id`),
...
CREATE TABLE `application_information_grant_types` (
  ...
  KEY `FK_61a6f8b0091946139543874f559` (`application_information_id`),
  CONSTRAINT `FK_61a6f8b0091946139543874f559` FOREIGN KEY (`application_information_id`) REFERENCES `application_information` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usage_summaries` (
  ...
  KEY `fk_usage_summaries_1_idx` (`usage_point_id`),
