/*
 * OpenESPI Seed Data - Application Information (PostgreSQL)
 * 
...
-- Clear existing data
TRUNCATE TABLE application_information_related_links CASCADE;
TRUNCATE TABLE application_information RESTART IDENTITY CASCADE;
