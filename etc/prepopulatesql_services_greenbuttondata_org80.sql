...
INSERT INTO application_information  (id, uuid, clientId, thirdPartyApplicationName, thirdPartyScopeSelectionScreenURI, thirdPartyNotifyUri, redirectURI, clientSecret) VALUES (1,'550e8400-e29b-41d4-a716-4466554413a0', 'third_party', 'Third Party (localhost)', 'http://services.greenbuttondata.org/ThirdParty/RetailCustomer/ScopeSelection', 'http://services.greenbuttondata.org/ThirdParty/espi/1_1/Notification', 'http://services.greenbuttondata.org/ThirdParty/espi/1_1/OAuthCallBack', 'secret');
